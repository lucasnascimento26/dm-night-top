...
export function OrnamentDivider() {
  return (
    <div className="flex items-center justify-center gap-3 text-fuchsia-400/70 my-3 gsap-fade">
...
function IconButton({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <button
      type="button"
      className="gsap-icon-btn flex flex-col items-center gap-2 text-purple-100/90 group"
    >
...
export const SPARKLES = [
  { top: "4%", left: "8%", size: 5, delay: 0 },
  { top: "10%", left: "88%", size: 4, delay: 0.4 },
  { top: "22%", left: "18%", size: 3, delay: 0.9 },
  { top: "18%", left: "78%", size: 5, delay: 1.3 },
  { top: "34%", left: "92%", size: 3, delay: 0.6 },
  { top: "40%", left: "4%", size: 4, delay: 1.6 },
  { top: "55%", left: "85%", size: 3, delay: 0.2 },
  { top: "62%", left: "10%", size: 5, delay: 1.1 },
  { top: "78%", left: "90%", size: 4, delay: 0.8 },
  { top: "88%", left: "6%", size: 3, delay: 1.4 },
  { top: "50%", left: "50%", size: 3, delay: 1.9 },
];
    ...
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      {SPARKLES.map((s, i) => (
        <span
          key={i}
          data-delay={s.delay}
          className="gsap-sparkle absolute rounded-full bg-fuchsia-200"
          style={{
            top: s.top,
            left: s.left,
            width: s.size,
...
export function MessageForm() {
  return (
    <section className="gsap-fade relative z-10 mt-7 rounded-[2rem] neon-card-border px-6 py-7">
      ...
      <button
        type="button"
        className="gsap-send-btn send-button mt-7 flex w-full items-center justify-center gap-3 rounded-full py-4 font-script text-2xl text-white transition-transform active:scale-[0.97]"
      >
        Enviar
